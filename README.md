...
| 69 | `spoken_odds` | The Age of Decadence | A dialogue list whose length depends on your build |
| 68 | `mage_thrones` | Lords of Magic: Special Edition | Nested unit-window roster whose grouping decides combat deployment |
